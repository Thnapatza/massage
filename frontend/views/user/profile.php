        ...
        <br>
        	<div class="col-md-12">
             				...
             				<div class="panel-body">
                				...
                				<h1>
                				<a href="room-created?id=<?=$model->id?>" class="btn btn-warning">เปิดห้องให้บริการ</a>
                				<a href="join-created?id=<?=$model->id?>" class="btn btn-info">ห้องที่ใช้บริการ</a>
                				</h1>
                				<div class="row">
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                          		<?php $user_join = Joinhangout::find()->where(['hangout_id'=>$r->hangout_id])->all()?>
                          		<form action="garantee" method="get">
                                	<div class="checkbox">
                                		<label><input type="checkbox" value=""><?=$r->hangout->createdby->username  ?></label>
                                		<?php  foreach ($user_join as $ro) :?>
                                		<?php if ($ro->user_id== Yii::$app->user->id){
                                		
                                		}else{?>
              						<label><input type="checkbox" value=""><?=$ro->user->username  ?></label>
              						<?php }?>
              						<?php  endforeach;?>
            						</div>
                          ...
                          <div class="modal-footer">
                          	<button class="btn btn-primary" href="#">ยืนยัน</button>
